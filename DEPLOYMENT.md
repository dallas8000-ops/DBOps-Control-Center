...
| `FRONTEND_ORIGINS` | `https://dbops-web.onrender.com` | Your live frontend URL |
...
**Stripe step-by-step:** [`docs/STRIPE_RENDER_SETUP.md`](./docs/STRIPE_RENDER_SETUP.md)  
**Verify after deploy:** `python scripts/verify_stripe_config.py` or `curl https://dbops-api.onrender.com/health/billing`

**dbops-web:** set `VITE_API_URL` = `https://dbops-api.onrender.com`
...
- [ ] Copy endpoint signing secret (`whsec_...`) into Render `STRIPE_WEBHOOK_SECRET`
...
3. Roll back deploy in Render or follow [Migration rollback](./docs/MIGRATION_ROLLBACK.md) for schema issues
