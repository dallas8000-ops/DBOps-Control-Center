# Listing prep checklist — before you publish anywhere

Complete these five items so buyers see a **product**, not a repo.
...
## Suggested listing bundle (zip or repo invite)

```
DBOps-Control-Center/          # source (private invite)
docs/commercial-assets/
  ONE_PAGE_PITCH.md
  REMAINING_5_PERCENT.md
  LICENSE_SALE_MODEL.md
  pricing-sheet.md
  onboarding-checklist-day0-day7.md
  support-sla-response-matrix.md
DBOps_LICENSE.md
LEGAL_NOTICE.md
```
...
- Respond to pre-sales with `DBOps_Product_Positioning.md` detail
- Deliver private repo or release tag within SLA in onboarding checklist
- Log each sale (email, variant, date) for exclusive covenant tracking
